            ...
            },
            {
                key: "initCalendar", value: function () {
                    ...
                    new FullCalendar.Calendar(document.getElementById("js-calendar"), {
                        ...
                        events: [
                            { title: "Gaming Day", start: new Date(r, n, 1), allDay: !0 },
                            { title: "Skype Meeting", start: new Date(r, n, 3) },
                            { title: "Project X", start: new Date(r, n, 9), end: new Date(r, n, 12), allDay: !0, color: "#e04f1a" },
                            { title: "Work", start: new Date(r, n, 17), end: new Date(r, n, 19), allDay: !0, color: "#82b54b" },
                            { id: 999, title: "Hiking (repeated)", start: new Date(r, n, t - 1, 15, 0) },
                            { id: 999, title: "Hiking (repeated)", start: new Date(r, n, t + 3, 15, 0) },
                            { title: "Landing Template", start: new Date(r, n, t - 3), end: new Date(r, n, t - 3), allDay: !0, color: "#ffb119" },
                            { title: "Lunch", start: new Date(r, n, t + 7, 15, 0), color: "#82b54b" },
                            { title: "Coding", start: new Date(r, n, t, 8, 0), end: new Date(r, n, t, 14, 0) },
                            { title: "Trip", start: new Date(r, n, 25), end: new Date(r, n, 27), allDay: !0, color: "#ffb119" },
                            { title: "Reading", start: new Date(r, n, t + 8, 20, 0), end: new Date(r, n, t + 8, 22, 0),data: "Votre chaîne de caractères ici" },
                            { title: "Follow us on Twitter", start: new Date(r, n, 22), allDay: !0, url: "http://twitter.com/pixelcave", color: "#3c90df" }
                        ]
                    }).render()
                }
            },
