...
\includegraphics[width=\paperwidth,height=\paperheight]{\VAR{image_path}carte_graphique6.png}
}}}

\newcommand\BackgroundPicVerso{
\put(0,0){
\parbox[b][\paperheight]{\paperwidth}{
\includegraphics[width=\paperwidth,height=\paperheight]{\VAR{image_path}carte_graphique_verso2.png}
}}}
...
\multirow {8}{7cm}{\includegraphics[width=7cm]{\VAR{image_path}images_cartes/\VAR{etudiant.contact}.png}}
   		& N\textdegree étudiant : & \VAR{ etudiant.id } \\ 
  		& Nom : & \VAR{ etudiant.nom } \\ 
 		& Prénom :  & \VAR{ etudiant.prenom }\\ 
 		& Né le : & \VAR{ other_information.date_naissance }\\ 
 		& A: & \VAR{ etudiant.lieunaissance } \\ 
 		& Sexe : & \VAR{ etudiant.sexe } \\ 
 		& Adresse : & \VAR{ other_information.adresse }\\ 
 		& Tél : & \VAR{ other_information.tel}\\ 
...
\includegraphics[scale=0.15]{\VAR{image_path}koumoi_signature.png}\\
\vspace{0cm}
...
\noindent
Année Academique {\color{blue} 2023-2024} \hspace{1cm} Niveau {\color{blue} \VAR{other_information.niveau}}\\
...
\noindent
\begin{tabular}{ccc}
Personne à prévenir : & \VAR{other_information.person_a_prev} 
\end{tabular}
