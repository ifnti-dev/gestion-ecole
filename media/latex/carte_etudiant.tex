...
\multirow {8}{7cm}{\includegraphics[width=7cm]{images_cartes/\VAR{etudiant.id}.png}}
   		& N\textdegree étudiant : & \VAR{ etudiant.id } \\ 
  		& Nom : & \VAR{ etudiant.nom } \\ 
 		& Prénom :  & \VAR{ etudiant.prenom }\\ 
 		& Né le : & \VAR{ date_naissance }\\ 
...
\noindent
Année Academique {\color{blue} \VAR{annee}} \hspace{1cm} Niveau {\color{blue} \VAR{niveau}}\\
