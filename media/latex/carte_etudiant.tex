...
\noindent
Année Academique {\color{blue} 2023-2024} \hspace{1cm} Niveau {\color{blue} \VAR{etudiant.niveau}}\\
...
\noindent
\begin{tabular}{ccc}
Personne à prévenir : & \VAR{etudiant.person_a_prev} 
\end{tabular}
