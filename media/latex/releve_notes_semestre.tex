...
\textbf{\VAR{ligne['ue'].libelle}} \\  \small \VAR{ligne['matieres_libelles']} & \VAR{ligne['moyenne']} & \BLOCK{if ligne['validation'] == True} \VAR{ligne['ue'].nbreCredits} \BLOCK{else} 0  \BLOCK{endif} & \VAR{ligne['anneeValidation']}\\
\hline
\BLOCK{endfor}
