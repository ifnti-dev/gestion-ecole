# Generated by Django 4.2.4 on 2023-11-28 08:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nature', models.CharField(choices=[('conge_annuel', 'Congé annuel'), ('conge_maternite', 'Congé de maternité'), ('conge_paternite', 'Congé de paternité'), ('autres', 'Autres')], max_length=30, verbose_name='Nature des congés')),
