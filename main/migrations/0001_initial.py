    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annee', models.DecimalField(decimal_places=0, max_digits=4, unique=True, verbose_name='Année universitaire')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codematiere', models.CharField(blank=True, max_length=50, verbose_name='Code de la matière')),
                ...
                ('abbreviation', models.CharField(default='Short', max_length=20, unique=True)),
