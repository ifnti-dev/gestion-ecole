    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nif', models.CharField(default=0, max_length=50, verbose_name="Num d'identification fiscale")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frais_prestations_familiales', models.DecimalField(decimal_places=2, default=0.03, max_digits=10)),
                ('frais_risques_professionnel', models.DecimalField(decimal_places=2, default=0.02, max_digits=10)),
                ('frais_pension_vieillesse_emsalaire', models.DecimalField(decimal_places=3, default=0.125, max_digits=10)),
                ('frais_prestations_familiale_salsalaire', models.DecimalField(decimal_places=2, default=0.04, max_digits=10)),
                ('assurance_maladie_universelle', models.DecimalField(decimal_places=2, default=0.05, max_digits=10, verbose_name='Assurance maladie universelle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annee_universitaire', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.anneeuniversitaire', verbose_name='Année Universitaire')),
                ('compte_bancaire', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.comptebancaire')),
                ('matiere', models.ManyToManyField(blank=True, null=True, related_name='Matières', to='main.matiere')),
